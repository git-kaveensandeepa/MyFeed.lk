        ...
        <div class="flex flex-col items-center md:items-start mt-4 relative z-10">
          ...
          <div class="flex flex-col xl:flex-row gap-8 w-full justify-center md:justify-start items-center">
            ...
            <div class="flex flex-wrap items-center justify-center md:justify-start gap-4">
              <a href="https://wa.me/94710947861" target="_blank" class="w-12 h-12 flex items-center justify-center rounded-full bg-white text-[#1d1d1f] border border-black/10 hover:bg-[#25D366] hover:text-white hover:border-[#25D366] transition-all active:scale-95 cursor-pointer shadow-sm" aria-label="WhatsApp (+94710947861)">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/></svg>
              </a>
              <a href="https://www.facebook.com/share/1USfMgpv23/" target="_blank" class="w-12 h-12 flex items-center justify-center rounded-full bg-white text-[#1d1d1f] border border-black/10 hover:bg-[#1877F2] hover:text-white hover:border-[#1877F2] transition-all active:scale-95 cursor-pointer shadow-sm" aria-label="Facebook">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
              </a>
              <a href="https://www.facebook.com/share/1USfMgpv23/" target="_blank" class="w-12 h-12 flex items-center justify-center rounded-full bg-white text-[#1d1d1f] border border-black/10 hover:bg-[#E1306C] hover:text-white hover:border-[#E1306C] transition-all active:scale-95 cursor-pointer shadow-sm" aria-label="Instagram">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
              </a>
              <a href="https://www.tiktok.com/@tt.kaveensandeepa?_r=1&_t=ZS-98YOabeHMxO" target="_blank" class="w-12 h-12 flex items-center justify-center rounded-full bg-white text-[#1d1d1f] border border-black/10 hover:bg-black hover:text-white hover:border-black transition-all active:scale-95 cursor-pointer shadow-sm" aria-label="TikTok">
              ...
              <a href="https://youtube.com/@yt.kaveensandeepa?si=aWabFdMMUleXuVvL" target="_blank" class="w-12 h-12 flex items-center justify-center rounded-full bg-white text-[#1d1d1f] border border-black/10 hover:bg-[#FF0000] hover:text-white hover:border-[#FF0000] transition-all active:scale-95 cursor-pointer shadow-sm" aria-label="YouTube">
