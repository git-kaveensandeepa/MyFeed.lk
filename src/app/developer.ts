        ...
        <div class="flex flex-col items-center md:items-start mt-4 relative z-10">
          ...
          <div class="flex flex-col xl:flex-row gap-8 w-full justify-center md:justify-start items-center">
            ...
            <div class="flex flex-wrap items-center justify-center md:justify-start gap-4">
              ...
              <a href="https://wa.me/94710947871" target="_blank" class="w-12 h-12 flex items-center justify-center rounded-full bg-white text-[#1d1d1f] border border-black/10 hover:bg-[#25D366] hover:text-white hover:border-[#25D366] transition-all active:scale-95 cursor-pointer shadow-sm" aria-label="WhatsApp">
