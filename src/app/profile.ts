        ...
        <section class="mb-6">
          ...
          <div class="bg-white dark:bg-[#1c1c1e] rounded-[20px] shadow-xs border border-black/[0.06] dark:border-white/[0.08] overflow-hidden divide-y divide-black/[0.06] dark:divide-white/[0.08] ios-card">
            ...
            <a 
              ...
              class="w-full p-4 flex items-center justify-between text-left hover:bg-emerald-50/50 dark:hover:bg-emerald-950/20 transition-colors ios-touch cursor-pointer group">
              <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-[12px] bg-[#25D366] text-white flex items-center justify-center shrink-0 shadow-md shadow-[#25D366]/20 group-hover:scale-105 transition-transform">
                ...
                <div>
                  <div class="text-sm font-bold text-[#000000] dark:text-white flex items-center gap-2">
                    ...
                    <span class="px-2 py-0.5 rounded-full text-[9px] font-extrabold bg-[#25D366]/15 text-[#25D366] uppercase">Instant Alerts</span>
                  </div>
                  <div class="text-xs text-[#8e8e93] mt-0.5">දිනපතා උණුසුම් තාක්ෂණික පුවත් කෙලින්ම ඔබගේ WhatsApp එකට</div>
                </div>
              </div>
              <div class="flex items-center gap-1 text-[#25D366] font-bold text-xs">
                <span>Join</span>
